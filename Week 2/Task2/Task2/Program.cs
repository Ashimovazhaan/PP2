...
namespace Task2
{
    class Program
    {
        static void IsPrime()
        {
            StreamReader sr = new StreamReader(@"C:\Users\Аружан\Desktop\c# folder\Input_Task2.txt");
            StreamWriter sw = new StreamWriter(@"C:\Users\Аружан\Desktop\c# folder\Output_task2.txt");
